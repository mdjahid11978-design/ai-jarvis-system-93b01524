...
import {
  usePrevious,
  useSize
} from "./chunk-FZN5EU53.js";
import {
  useId
} from "./chunk-OCN7DNWA.js";
import {
  createCollection,
  useDirection
} from "./chunk-6CQV2ANE.js";
import {
  composeEventHandlers,
  useCallbackRef,
  useControllableState,
  useLayoutEffect2
} from "./chunk-XIJV2AJP.js";
import {
  createContextScope
} from "./chunk-R75Q76IO.js";
import {
  Primitive,
...
var Portal = React8.forwardRef((props, forwardedRef) => {
  ...
  return container ? ReactDOM2.createPortal(jsx5(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
import { useState as useState8, useCallback as useCallback3, useEffect as useEffect8, useLayoutEffect as useLayoutEffect4 } from "react";
...
var Select = (props) => {
  ...
  return jsx7(Root2, { ...popperScope, children: jsxs(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        jsx7(Collection.Provider, { scope: __scopeSelect, children: jsx7(
        ...
        isFormControl ? jsxs(
          BubbleSelect,
          {
            ...
            form,
            children: [
              value === void 0 ? jsx7("option", { value: "" }) : null,
...
var SelectTrigger = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return jsx7(Anchor, { asChild: true, ...popperScope, children: jsx7(
      Primitive.button,
      {
        type: "button",
        role: "combobox",
  ...
  (props, forwardedRef) => {
    ...
    return jsx7(
      Primitive.span,
      {
        ...
        children: shouldShowPlaceholder(context.value) ? jsx7(Fragment4, { children: placeholder }) : children
      }
    );
  }
);
...
var SelectIcon = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return jsx7(Primitive.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME2 = "SelectPortal";
var SelectPortal = (props) => {
  return jsx7(Portal, { asChild: true, ...props });
};
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM3.createPortal(
        jsx7(SelectContentProvider, { scope: props.__scopeSelect, children: jsx7(Collection.Slot, { scope: props.__scopeSelect, children: jsx7("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
    return jsx7(SelectContentImpl, { ...props, ref: forwardedRef });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return jsx7(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: jsx7(Combination_default, { as: Slot, allowPinchZoom: true, children: jsx7(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return jsxs(Fragment4, { children: [
      jsx7(
        "style",
        {
      ...
      jsx7(Collection.Slot, { scope: __scopeSelect, children: jsx7(
        Primitive.div,
        {
...
var SelectGroup = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return jsx7(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: jsx7(Primitive.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return jsx7(Primitive.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    const nativeOption = React19.useMemo(
      () => jsx7("option", { value: itemContext.value, disabled: itemContext.disabled, children: textContent }, itemContext.value),
    ...
    return jsxs(Fragment4, { children: [
      jsx7(Primitive.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? jsx7(Primitive.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectSeparator = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return jsx7(Primitive.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
...
var SelectArrow = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? jsx7(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
...
var BubbleSelect = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return jsx7(VisuallyHidden, { asChild: true, children: jsx7("select", { ...selectProps, ref: composedRefs, defaultValue: value }) });
  }
);
